    ...
    return (
      <Container className="flex min-h-[320px] items-center justify-center mt-8">
        <div className="flex items-center gap-x-2">
          ...
          An error occurred while loading banners. Please reload the page and try again. If the error remains, try again later.
          </Text>
        </div>
      </Container>
    );
        ...
        <Container className="flex flex-col min-h-[640px] grow h-full w-full">
          <div className="flex justify-between align-top border-grey-20 border-b pb-4">
            <div>
              ...
              Here you can manage banners and create new promotional materials
              </h3>
            </div>
            {
                canAdd ? <Button
