...
function ProductCategoriesEmptyState() {
  return (
    <div className="flex min-h-[600px] items-center justify-center">
      ...
      No categories found. Use the button above to create the first category.
      </p>
    </div>
  );
}
...
An error occurred while loading categories. Please reload the page and try again. If the error remains, try again later.
        </Text>
      </div>
    </Container>
  );
      ...
      <Container className="flex flex-col min-h-[640px] grow h-full w-full">
        <div className="flex justify-between align-top border-grey-20 border-b pb-4">
          <div>
            ...
            Here you can manage categories and keep your products organized.
            </h3>
          </div>
          <Button
            variant="secondary"
