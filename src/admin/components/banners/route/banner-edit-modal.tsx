    ...
    if (createNew) {
      ...
      mutateCreateAsync(payloadNew, {
        onSuccess: async ({banner}) => {
          notify.success("Success", `Банер з ID ${banner.id} створено`);
          onReset();
      ...
      <Drawer.Content className="w-auto right-2 overflow-y-scroll">
        <form onSubmit={onSubmit}>
                  ...
                  <Controller
                    ...
                    render={({ field: { onChange, ...other } }) => (
                      <Select {...other} onValueChange={onChange}>
                        <Select.Trigger>
                          <Select.Value placeholder="Select the link type for the banner" />
                        </Select.Trigger>
                        <Select.Content>
                          {types.map((item) => (
                ...
                <div className="flex flex-col flex-1 gap-y-2">
                  ...
                  <Controller
                    ...
                    render={({ field: { onChange, ...other } }) => (
                      <Select {...other} onValueChange={onChange}>
                        <Select.Trigger>
                          <Select.Value placeholder="Choose a related category for the banner" />
                        </Select.Trigger>
                        <Select.Content>
                          {
                ...
                <div className="flex flex-col flex-1 gap-y-2">
                  ...
                  <Controller
                    ...
                    render={({ field: { onChange, ...other } }) => (
                      <Select {...other} onValueChange={onChange}>
                        <Select.Trigger>
                          <Select.Value placeholder="Choose a related product for the banner" />
                        </Select.Trigger>
                        <Select.Content>
                          {
          ...
          <Drawer.Footer>
            ...
            <Button isLoading={isLoadingCreation || isLoadingUpdate || isSaving}>save</Button>
          </Drawer.Footer>
        </form>
      </Drawer.Content>
    </Drawer>
