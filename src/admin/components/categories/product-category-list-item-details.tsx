              ...
              >
                <div className="flex items-center gap-x-2">
                  ...
                  <div className="select-none text-xs text-ui-fg-muted min-w-16">
                    {`(${item.metadata.is_featured as string})`}
                  </div>
                  <div className="select-none text-xs text-ui-fg-muted min-w-16">
                    {`(${item.metadata.visitsCount as number})`}
                  </div>
                  <div className="text-base">
                  {item.metadata.is_featured === "featured" && (
                    <Tooltip content={`Featured Category`}>
                      <StatusBadge color={"green"} className="border-none">
                        Featured
                      </StatusBadge>
                    </Tooltip>
                  )}
