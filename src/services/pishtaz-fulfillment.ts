...
class PishtazFulfillmentService extends AbstractFulfillmentService {
    ...
    constructor(container: MedusaContainer, options) {
        ...
        this.options_.default_template = process.env.INPOST_DEFAULT_TEMPLATE
        this.options_.sourceState = process.env.SOURCE_PROVINCE
        this.options_.edgeProvinces = process.env.EDGE_PROVINCES.split(",")
        this.options_.insideStatePrice = process.env.INSIDE_PROVINCE_PRICE
        this.options_.edgeStatePrice = process.env.EDGE_PROVINCE_PRICE
        this.options_.outsideStatePrice = process.env.OUTSIDE_PROVINCE_PRICE
    }
    ...
    async calculatePrice(
        ...
        console.log('کد استان:', province)

        if (province === this.options_.sourceState) {
            return this.options_.insideStatePrice
        } else if (this.options_.edgeProvinces.includes(province)) {
            return this.options_.edgeStatePrice
        } else {
            return this.options_.outsideStatePrice
        }
    }
